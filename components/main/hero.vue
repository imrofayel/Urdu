...
<template>
    <div class="w-full items-center justify-center flex relative sm:-right-[100px] -right-[90px]">

        <Icon name="lucide:binary" color="#B0BEC5" class="rotate-[10deg] relative sm:right-[420px] sm:-top-10 size-[40px] sm:size-[44px] -top-10 right-[320px]"></Icon>
                
        <Icon name="lucide:flame" color="#FF3D00" class="rotate-[10deg] relative sm:right-[250px] sm:top-[65px] size-[38px] sm:size-[40px] top-[50px] right-[200px]"></Icon>
